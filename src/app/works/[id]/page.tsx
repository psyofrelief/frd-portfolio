...
export default function SingleWorkPage() {
  return (
    <>
      <section className="px-xs pb-xl pt-nav-mobile sm:pt-3xl flex flex-col min-h-screen-minus-nav-mobile sm:min-h-screen-minus-nav gap-y-xl">
            ...
            <div className="lg:col-span-7 lg:col-start-3 lg:row-start-2 flex flex-col gap-y-sm">
              ...
              <div className="grid sm:grid-cols-2 gap-x-lg gap-y-sm  text-xs">
                <p>
                  ...
                  design characteristics of the first ever Bearbrick toy
                  speaker, but that would also be a reliable, easy and
                  functional tool to gauge interest and sign-ups pre-launch as
                  well as convert in sales post-launch. An immersive experience
                  for a one of a kind, art piece audio device.
                </p>
                <p>
                  With the launch of the new Bearbrick audio, Medicom needed a
                  platform that would not only talk to the unique features and
